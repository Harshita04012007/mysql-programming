...
select * from employees;
#8.Write a query to update the email for John Doe to john.deo@company.com*/
update employees
...
drop email;
select *from employees;
/*13.Write a query to find the employee with the higher salary.*/
